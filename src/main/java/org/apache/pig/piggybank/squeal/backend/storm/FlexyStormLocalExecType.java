 ...
 *
 */
public class FlexyStormLocalExecType implements ExecType {

    private static final long serialVersionUID = 1L;
    protected static final String[] modes = { "FLEXY-STORM-LOCAL" };
    ...
    public ExecutionEngine getExecutionEngine(PigContext pigContext) {
        ...
        return new FlexyStormExecutionEngine(pigContext, true);
    }

    @Override
    public Class<? extends ExecutionEngine> getExecutionEngineClass() {
    	return FlexyStormExecutionEngine.class;
    }
